...
class UpdateCardViewController: UIViewController {
    ...
    private lazy var cardBrandDropDown: DropdownFieldElement = {
        ...
        cardBrandDropDown.select(index: indexToSelect ?? 0, shouldAutoAdvance: false)
    ...
    private lazy var cardSection: SectionElement = {
        ...
        let section = SectionElement(elements: subElements, theme: appearance.asElementsTheme)
